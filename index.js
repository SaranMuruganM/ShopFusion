...
const displayProducts=(productsInformation)=>{
...
localStorage.setItem('localProducts',JSON.stringify(productsInformation))
fetch("https://fakestoreapi.com/products")
.then((data)=>data.json())
.then((productsInformation)=>displayProducts([...productsInformation,...JSON.parse(localStorage.getItem('localProducts'))]));
